...
//----------------------------UPLOADFILES------------------------------------
            ...
            if (thisS.options.preview) {
                var getTemplate = function (content) {
                    return '<table class="ssi-imgToUploadTable ssi-pending">' +
                     ...
                     '<tr><td style="height:0;"><div id="ssi-uploadProgress' + index + '" class="ssi-hidden ssi-uploadProgress"></div></td></tr>' +
    ...
    var locale = {
        ...
        cn:{
            ...
            extError: '$1 类型不支持',//$1=file extension ie(exe files are not supported)
            someErrorsOccurred: '发生了某些错误!'
